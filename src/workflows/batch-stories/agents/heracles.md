...
2. **Execute the pipeline** — Run the full 9-phase story-pipeline for that ONE story
...
1. **`{project_root}/_bmad/pantheon/workflows/story-pipeline/workflow.md`** — The complete 9-phase pipeline definition
